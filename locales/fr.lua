local Translations = {
    error = {
        ...
        on_duty_sasp_only = 'Reservé aux policiers en service.',
    ...
    info = {
        ...
        bill = 'Amender',
        amount = 'Montant',
        sasp_plate = 'LSPD', --Should only be 4 characters long
    ...
    menu = {
        garage_title = 'Véhicule de sasp',
        close = '⬅ Fermer le menu',
        impound = 'Fourrière',
        pol_impound = 'Fourrière de sasp',
        pol_garage = 'Garage de sasp',
        pol_armory = 'Armurerie',
    },
    email = {
        sender = 'Agence Centrale de Collection Judiciare',
        subject = 'Collection de dette',
        message = 'Cher(e) %{value}. %{value2}, <br /><br />L\'Agence Centrale de Collection judiciaire (ACCJ) à facturé les amendes que vous avez reçu de la sasp.<br />Il y à <strong>$%{value3}</strong> qui ont été retiré de votre compte.<br /><br />Cordialement,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Poser une herse (sasp Only)',
        license_grant = 'Donner un Permis a quelqu\'un',
        license_revoke = 'Révoqué un Permis',
        place_object = 'Placer/Supprimer un objet (sasp Only)',
        cuff_player = 'Menotter un joueur (sasp Only)',
        escort = 'Escorter un joueur',
        callsign = 'Donner vous un matricule',
        clear_casign = 'Nettoyer les douilles de la zone (sasp Only)',
        jail_player = 'Mettre un joueur un prison (sasp Only)',
        unjail_player = 'Sortir un joueur de prison (sasp Only)',
        clearblood = 'Nettoie la zone du sang (sasp Only)',
        seizecash = 'Saisir du Cash (sasp Only)',
        softcuff = 'Menotter calmement (sasp Only)',
        camera = 'Voir les caméras de sécurité (sasp Only)',
        flagplate = 'Signaler une plaque (sasp Only)',
        unflagplate = 'Retirer un signalement de plaque (sasp Only)',
        plateinfo = 'Verifier une plaque (sasp Only)',
        depot = 'Mettre en fourrière avec un prix (sasp Only)',
        impound = 'Mettre en fourrière (sasp Only)',
        paytow = 'Payer le dépanneur (sasp Only)',
        paylawyer = 'Payer l\'avocat (sasp, Judge Only)',
        anklet = 'Attacher un bracelet éléctronique (sasp Only)',
        ankletlocation = 'Recevoir la position d\'un bracelet éléctronique',
        removeanklet = 'Retirer un bracelet éléctronique (sasp Only)',
        drivinglicense = 'Saisir le permis de conduire (sasp Only)',
        takedna = 'Prendre un échantillon ADN de quelqu\'un (Sac de preuve vide requis) (sasp Only)',
        sasp_report = 'Rapport de sasp',
