local Translations = {
    error = {
        ...
        on_duty_sasp_only = 'For on-duty sasp only',
    ...
    menu = {
        garage_title = 'sasp Vehicles',
        close = '⬅ Close Menu',
        impound = 'Impounded Vehicles',
        pol_impound = 'sasp Impound',
        pol_garage = 'sasp Garage',
        pol_armory = 'sasp Armory',
    },
    email = {
        sender = 'Central Judicial Collection Agency',
        subject = 'Debt collection',
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the sasp.<br />There is <strong>$%{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Place Spike Strip (sasp Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (sasp Only)',
        cuff_player = 'Cuff Player (sasp Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (sasp Only)',
        jail_player = 'Jail Player (sasp Only)',
        unjail_player = 'Unjail Player (sasp Only)',
        clearblood = 'Clear The Area of Blood (sasp Only)',
        seizecash = 'Seize Cash (sasp Only)',
        softcuff = 'Soft Cuff (sasp Only)',
        camera = 'View Security Camera (sasp Only)',
        flagplate = 'Flag A Plate (sasp Only)',
        unflagplate = 'Unflag A Plate (sasp Only)',
        plateinfo = 'Run A Plate (sasp Only)',
        depot = 'Impound With Price (sasp Only)',
        impound = 'Impound A Vehicle (sasp Only)',
        paytow = 'Pay Tow Driver (sasp Only)',
        paylawyer = 'Pay Lawyer (sasp, Judge Only)',
        anklet = 'Attach Tracking Anklet (sasp Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (sasp Only)',
        drivinglicense = 'Seize Drivers License (sasp Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (sasp Only)',
        sasp_report = 'sasp Report',
