    ...
    if coords then
        QBCore.Functions.SpawnVehicle(vehicle.vehicle, function(veh)
            QBCore.Functions.TriggerCallback('qb-garage:server:GetVehicleProperties', function(properties)
                ...
                TriggerServerEvent('sasp:server:TakeOutImpound',vehicle.plate)
                closeMenuFull()
...
RegisterNetEvent('qb-sasp:client:spawnHelicopter', function(k)
    if IsPedInAnyVehicle(PlayerPedId(), false) then
        ...
        QBCore.Functions.SpawnVehicle(Config.saspHelicopter, function(veh)
...
if Config.UseTarget then
    ...
    CreateThread(function ()
        ...
        while true do
            local sleep = 1000
            if inDuty and PlayerJob.name == "sasp" then
                sleep = 5
