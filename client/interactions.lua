...
RegisterNetEvent('sasp:client:JailCommand', function(playerId, time)
    TriggerServerEvent("sasp:server:JailPlayer", playerId, tonumber(time))
end)

RegisterNetEvent('sasp:client:BillCommand', function(playerId, price)
    TriggerServerEvent("sasp:server:BillPlayer", playerId, tonumber(price))
end)
...
RegisterNetEvent('sasp:client:GetKidnappedDragger', function(playerId)
    QBCore.Functions.GetPlayerData(function(PlayerData)
